...
.PHONY: help ll-ch05 ll-ch06 ll-ch07 ll-ch08 ll-ch085 ll-ch09 ll-ch10 ll-ch11 ll-ch12
help:
...
ll-ch12: docs
	$(PYTHON) -m ledgerloom.chapters.ch12_fixed_assets_depreciation --outdir $(OUT_LL) --seed $(SEED)
