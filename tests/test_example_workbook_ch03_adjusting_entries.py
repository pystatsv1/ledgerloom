...
def test_example_workbook_ch03_adjusting_entries_cli_is_runnable_and_deterministic(tmp_path: Path) -> None:
    repo_root = Path(__file__).resolve().parents[1]
    src = repo_root / "examples" / "workbook" / "ch03_adjusting_entries"
    assert src.exists(), "Expected examples/workbook/ch03_adjusting_entries to exist in the repo"

    project_root = tmp_path / "ch03_adjusting_entries"
